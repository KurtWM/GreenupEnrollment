...
namespace DotNetNuke.Modules.GreenupEnrollment
{
    ...
    /// are accessible to your module's controls (that inherity from GreenupEnrollmentSettingsBase
    /// 
    /// </summary>


    public class GreenupEnrollmentSettingsBase : ModuleSettingsBase
    {
