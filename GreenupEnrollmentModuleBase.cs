...
namespace DotNetNuke.Modules.GreenupEnrollment
{
    ...
    /// are accessible to your module's controls (that inherity from GreenupEnrollmentModuleBase
    /// 
    /// </summary>

    public class GreenupEnrollmentModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
